<template>
  <footer>
    <div
      class="w-full bg-green-300 text-gray-900 absolute inset-x-0 bottom-0 h-1"
    >
      <div
        class="xl:px-40 pb-12 lg:px-20 md:px-10 sm:px-5 px-10 bg-gradient-to-br from-green-100 to-green-300"
      >
        <div
